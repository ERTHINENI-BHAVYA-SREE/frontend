...
export const issueABook = (book)=> async dispatch =>{
    ...
    try {
        const response = await axios.post('https://backend2-dfiv.onrender.com/api/issues/issueRequest',book);
...
export const singleissueABook = (postId)=> async dispatch =>{
    ...
    try {
        const response = await axios.post('https://backend2-dfiv.onrender.com/api/issues/singleIssuedBook',{postId});
        dispatch({
...
export const getUserIssuedBook = () => async (dispatch, getState) => {
    ...
    try {
        const response = await axios.get(`https://backend2-dfiv.onrender.com/api/issues/issuedBook`, config);
        dispatch({
...
export const getAllIssuedBook = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get(`https://backend2-dfiv.onrender.com/api/issues/allIssuedBook`);
...
export const getAllBookIssueReq = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('https://backend2-dfiv.onrender.com/api/issues/allIssueRequest');
        dispatch({
...
export const getAllBookReturnReq = ()=> async dispatch =>{
    ...
    try {
        const response = await axios.get('https://backend2-dfiv.onrender.com/api/issues/allreturnedBook');
        dispatch({
...
export const issuedReq = (bookId,postId)=> async dispatch =>{
    ...
    try {
         await axios.post('https://backend2-dfiv.onrender.com/api/issues/issuedReqAccept' , {bookId,postId})
       
        const response2 = await axios.get('https://backend2-dfiv.onrender.com/api/issues/allIssueRequest');
        dispatch({
           type:'GET_All_ISSUES_SUCCESS',
...
export const returnReqAction = (obj)=> async dispatch =>{
    ...
    try {
         await axios.post('https://backend2-dfiv.onrender.com/api/issues/returnReq' , obj)
...
export const issuedReqDeletedByAdmin = (postId)=> async dispatch =>{
    ...
    try {
       await axios.post('https://backend2-dfiv.onrender.com/api/issues/issueReqDelete' , {postId})
...
export const issueABookReturn = (postId)=> async dispatch =>{
    ...
    try {
        await axios.post('https://backend2-dfiv.onrender.com/api/issues/issuedBookDelete',{postId});
        const response2 = await axios.get(`https://backend2-dfiv.onrender.com/api/issues/issuedBook`, config);
